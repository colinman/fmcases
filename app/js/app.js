...
var app, iced, __iced_k, __iced_k_noop,
  __slice = [].slice;
  ...
  '$scope', '$localStorage', '_', 'pageTypes', 'recents', 'data', 'utilFunctions', '$http', '$sce', 'favorites', '$timeout', function($scope, $localStorage, _, pageTypes, recents, data, utilFunctions, $http, $sce, favorites, $timeout) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/Users/colinman/fmcases/app/js/app.coffee",
            funcname: "pushPage"
          });
    ...
    $scope.search = function(words) {
      ...
      return $http.get("/search/" + words).success(function(data) {
        ...
        return $scope.progressText = data === [] ? "No results found for " + words : "Results found for " + words;
      });
    };
